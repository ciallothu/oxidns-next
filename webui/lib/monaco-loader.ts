...
// default jsdelivr CDN. OxiDNS Next serves the WebUI from the device itself, often on
// a LAN with no outbound internet — or with the CDN blocked/unresolvable, at
// times by OxiDNS Next's own DNS rules. A CDN dependency leaves the YAML editor stuck
...
// imported by lib/oxidns-next-yaml-monaco.ts, which every editor entry point already
