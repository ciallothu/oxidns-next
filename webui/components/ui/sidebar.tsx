      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{t(WEBUI.shell.sidebar)}</SheetTitle>
            <SheetDescription>
              {t(WEBUI.shell.sidebarDescription)}
            </SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">{t(WEBUI.shell.toggleSidebar)}</span>
    </Button>
  );
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={t(WEBUI.shell.toggleSidebar)}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={t(WEBUI.shell.toggleSidebar)}
      className={cn(
