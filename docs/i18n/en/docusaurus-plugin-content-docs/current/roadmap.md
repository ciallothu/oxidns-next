...
This page tracks the upstream technical roadmap. OxiDNS Next retains account authentication, multiple SQL backends and its independent release channel; upstream versions are not Next versions.
